  ...
  useEffect(()=>{
    onAuthStateChanged(auth, (user) => {
      if (user) {
        ...
        setUser(false);
        console.log("user is not signedin or logedin");
      }
    });
  },[])
  ...
  return (
    ...
    <StatusBar style="light"></StatusBar>
      <NavigationContainer>
        ...
        {user ? (
          <>
           <Stack.Screen  name='Landing' options={{headerShown:false}} component={LandingPage} ></Stack.Screen>
           <Stack.Screen name='Home' options={{headerShown:false}} component={HomePage} ></Stack.Screen>
          </>
        ) : (
          <>
